...
export default function Pickup() {
    ...
    return <div className="h-pickup pb-pickup-bottom">
        <div className="h-full bg-gray-100 relative">
            <h2 className="absolute top-pickup-heading-30 left-pickup-heading-90 w-pickup-heading">
                <Image className="" src={pickupPath} alt="ピックアップ" width={300} height={0}/>
            </h2>
            <div className="absolute h-full w-full px-30 flex justify-between items-center">
                <NavigationButton width={buttonWidth} height={butonHeight} maxWidth={buttonMaxWidth} maxHeight={buttonMaxHeight}>
